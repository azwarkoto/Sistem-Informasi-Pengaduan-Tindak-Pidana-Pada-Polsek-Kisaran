    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-danger">
                <strong>Selamat Datang di Pengaduan Tindak Pidana Pada Polsek Kisaran</strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Arsip Berkas Pelaporan</h3>
                </div>
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="30%">No. Pelapor</th><th>Nama Pelapor</th><th>Tanggal Masuk</th><th>Masalah</th><th>Status</th>
                            </tr>
                        </thead>
                        <tbody>
